...
//
//    @Test
//    public void createEntryToWallet_returnsBadRequestStatus_whenWalletEntryServiceReturnsEmptyOptional() throws
//    Exception {
//        var requestData = createValidData();
//
//        given(walletEntryService.createEntryToWallet(eq(WALLET_ID), any(WalletEntryData.class))).willReturn
//        (Optional.empty());
//
//        mvc.perform(post(BASE_URL)
